...
var scramblers333 = {
  ...
  register: function (name, initialize, setRandomSource, getScramble) {
    this.scramblers[name] = {
      initialize: src => initialize(src),
      setRandomSource,
      getRandomScramble: (args) => ({ scramble_string: getScramble(args) }),
...
function setScramblers(scramblers) {
  scramblers
    .register('c', initialize, setRandomSrc, () => getCustomScramble({cp: [5,6,7]}))
    // .register('333', initialize, setRandomSrc, getRandomScramble)
    // .register('edges', initialize, setRandomSrc, getEdgeScramble)
    // .register('LL', initialize, setRandomSrc, getLLScramble)
    // .register('LSLL', initialize, setRandomSrc, getLSLLScramble)
    // .register('ZZLSLL', initialize, setRandomSrc, getZZLSLLScramble)
    // .register('ZZL2SLL', initialize, setRandomSrc, getZZL2SLLScramble)
    .register('ZBLL', initialize, setRandomSrc, (args) => {
    ...
    .register('TRIZBLL', initialize, setRandomSrc, (args) => {
      let s = rn(4);
    ...
    .register('2GLL', initialize, setRandomSrc, (args) => {
      let co = getRandomCO(args);
    ...
    .register('TSLE', initialize, setRandomSrc, (args) => {
      if (!args.length) {
    ...
    // .register('NLS', initialize, setRandomSrc, () => {
    //   return getCustomScramble({
    ...
    // .register('PLL', initialize, setRandomSrc, getPLLScramble)
    // .register('ZZLL', initialize, setRandomSrc, getZZLSScramble)
    // .register('CMLL', initialize, setRandomSrc, getCMLLScramble)
    // .register('CMLLSune', initialize, setRandomSrc, () => {
    //   let s = rn(2)+1;
    ...
    // .register('BLE', initialize, setRandomSrc, () => {
    //   let ble = function () {
    ...
    //   })
    // })
    // .register('LCCP', initialize, setRandomSrc, (args) => {
    ...
    //   });
    // })
    .register('CLS', initialize, setRandomSrc, (args) => {
      if (!args.length) {
    ...
    // .register('WV', initialize, setRandomSrc, (args) => {
    //   let s = 0;//rn(4);
    ...
    .register('ZZ', initialize, setRandomSrc, (args) => {
...
setScramblers(scramblers333);

module.exports = { scramblers333: scramblers333.scramblers };
