 ...
 */
Scrambow.prototype.type = function(type) {
 ...
 */
Scrambow.prototype.get = function(num) {
  num = num || 1;
 ...
 */
Scrambow.prototype.seed = function(seed) {
 ...
 * @param {num|Math} random source
 */
Scrambow.prototype.length = function(length) {
 ...
 */
Scrambow.prototype.init = function() {
